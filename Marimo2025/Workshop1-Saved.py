...
def _(mo):
    ...
    **The expected value $E[X] = \dfrac{3}{4} = 7.50\times10^{-1}\;$**
    ...
    I have chosen 3SF as a sensible-seeming number of sig figs, and I am expressing in scientific notation to make it super-easy to cross-check with python.
    """
    )
    return
